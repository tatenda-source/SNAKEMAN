...
const FEATURES = [
  { icon: Camera, label: "Identify", sub: "AI-powered ID", route: "/identify", color: "#22C55E" },
  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Hero */}
        <LinearGradient colors={["#071209", "#030A05"]} style={styles.hero}>
...
const styles = StyleSheet.create({
  ...
  badge: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 20, backgroundColor: "rgba(34,197,94,0.1)", borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, alignSelf: "flex-start", borderWidth: 1, borderColor: "rgba(34,197,94,0.2)" },
  badgeDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#22C55E" },
  badgeText: { color: "#22C55E", fontSize: 11, fontWeight: "700", letterSpacing: 1 },
  heroTitle: { fontSize: 52, fontWeight: "900", color: "#F0FDF4", lineHeight: 54, marginBottom: 4 },
  heroAccent: { color: "#22C55E" },
  heroSub: { fontSize: 28, fontWeight: "900", color: "#F0FDF4", marginBottom: 16 },
  ...
  featureLabel: { color: "#F0FDF4", fontSize: 12, fontWeight: "700", marginBottom: 2 },
  ...
  sectionTitle: { color: "#F0FDF4", fontSize: 18, fontWeight: "700" },
  ...
  snakeName: { color: "#F0FDF4", fontSize: 11, fontWeight: "700", textAlign: "center", marginBottom: 8 },
  dangerBadge: { borderRadius: 10, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1 },
  dangerText: { fontSize: 9, fontWeight: "700" },
  tipCard: { backgroundColor: "rgba(34,197,94,0.06)", borderRadius: 20, padding: 18, borderWidth: 1, borderColor: "rgba(34,197,94,0.15)" },
  tipHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 10 },
  tipTitle: { color: "#22C55E", fontSize: 12, fontWeight: "700", letterSpacing: 0.5 },
  tipText: { color: "#9CA3AF", fontSize: 13, lineHeight: 20, marginBottom: 12 },
  tipCta: { flexDirection: "row", alignItems: "center", gap: 4 },
  tipCtaText: { color: "#22C55E", fontSize: 12, fontWeight: "600" },
});
