...
const SNAKES = [
  ...
  { id: "green-mamba", name: "Green Mamba", sci: "Dendroaspis angusticeps", danger: "HIGH", accent: "#F87171" },
        ...
        <View style={styles.articlesList}>
          {filteredArticles.map((a) => (
            <TouchableOpacity key={a.id} style={styles.articleCard} activeOpacity={0.85}>
              <View style={[styles.articleType, { backgroundColor: a.type === "tip" ? "rgba(245,158,11,0.15)" : "rgba(220,38,38,0.12)" }]}>
                <BookOpen size={12} color={a.type === "tip" ? "#F59E0B" : "#DC2626"} />
                <Text style={[styles.articleTypeText, { color: a.type === "tip" ? "#F59E0B" : "#DC2626" }]}>
                  {a.type.toUpperCase()}
                </Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: "#FFF5F5", fontSize: 14 },
  sectionTitle: { color: "#FFF5F5", fontSize: 18, fontWeight: "700", paddingHorizontal: 20, marginBottom: 14 },
  ...
  snakeName: { color: "#FFF5F5", fontSize: 12, fontWeight: "700", textAlign: "center", marginBottom: 2 },
  ...
  articleTitle: { color: "#FFF5F5", fontSize: 14, fontWeight: "600", lineHeight: 20, marginBottom: 10 },
